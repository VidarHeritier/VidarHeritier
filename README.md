...
<div align="center"class="flex-container"><!-- .element: style="display: flex; flex-direction: row;" -->
     <h6>Nå meg på</h6><!-- .element: style="margin: 10px; padding: 20px;"-->
     <h1 ><a href="mailto:vidarheritier&#64;gmail.com"> 📧 </a></h1><!-- .element: style="margin: 10px; padding: 20px;"-->
     <h6>med en gang</h6><!-- .element: style="margin: 10px; padding: 20px;"-->
</div>
        </textarea>
</section>
     </body>
